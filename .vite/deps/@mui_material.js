...
} from "./chunk-WJHTXPKI.js";
import {
  Box_default,
  boxClasses_default
} from "./chunk-E7U3TIQU.js";
import {
...
var Tooltip = React66.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React66.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime70.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime70.jsxs)(React66.Fragment, {
    children: [React66.cloneElement(children, childrenProps), (0, import_jsx_runtime70.jsx)(PopperSlot, {
...
var Step = React71.forwardRef(function Step2(inProps, ref) {
  ...
  return (0, import_jsx_runtime74.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime74.jsxs)(React71.Fragment, {
...
var StepButton = React74.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React74.cloneElement(children, childProps) : (0, import_jsx_runtime79.jsx)(StepLabel_default, {
    ...childProps,
    children
  });
...
var SwipeableDrawer = React79.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  return (0, import_jsx_runtime84.jsxs)(React79.Fragment, {
...
var Tab = React81.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime86.jsxs)(TabRoot, {
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime86.jsxs)(React81.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime86.jsxs)(React81.Fragment, {
      children: [label, icon]
    }), indicator]
  });
});
