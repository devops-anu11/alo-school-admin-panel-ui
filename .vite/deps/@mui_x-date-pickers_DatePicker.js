import {
  ...
  useViews,
  validateDate
} from "./chunk-LGTDMZZU.js";
import "./chunk-D3WWLY52.js";
import "./chunk-AVBJDU3V.js";
import {
  IconButton_default,
  useMediaQuery_default
} from "./chunk-X3DOQZFF.js";
import "./chunk-FCR5ONVL.js";
import {
  ButtonBase_default
} from "./chunk-RVNJJJ5O.js";
import {
  useThemeProps
} from "./chunk-V5ALZ6JS.js";
import {
  Fade_default,
  useSlotProps_default
} from "./chunk-F4ZZ7XGZ.js";
import {
  CSSTransition_default,
  TransitionGroup_default,
  refType_default,
  resolveComponentProps_default
} from "./chunk-L6D6NRHB.js";
import "./chunk-AIHAQKB3.js";
import "./chunk-DPJPKJB6.js";
...
import {
  Typography_default
} from "./chunk-RKVD76DG.js";
import "./chunk-X33PS27K.js";
...
var useCalendarState = (params) => {
  ...
  const adapter = usePickerAdapter();
  const reducerFn = React5.useRef(createCalendarStateReducer(Boolean(reduceAnimations), adapter)).current;
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React10.useMemo(() => adapter.getMonth(day) !== currentMonthNumber, [adapter, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React10.useMemo(() => selectedDays.filter((day) => !!day).map((day) => adapter.startOfDay(day)), [adapter, selectedDays]);
  ...
  return (0, import_jsx_runtime6.jsxs)(PickersCalendarDayRoot, {
    ...
    children: [(0, import_jsx_runtime6.jsxs)(PickersCalendarDayHeader, {
      ...
      }), getWeekdays(adapter, now).map((weekday, i) => (0, import_jsx_runtime6.jsx)(PickersCalendarWeekDayLabel, {
        variant: "caption",
        role: "columnheader",
...
var _excluded8 = ["autoFocus", "className", "currentMonth", "classes", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "shouldDisableMonth", "readOnly", "disableHighlightToday", "onMonthFocus", "hasFocus", "onFocusedViewChange", "monthsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var MonthCalendar = React12.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React12.useMemo(() => adapter.getMonth(now), [adapter, now]);
  ...
  const [focusedMonth, setFocusedMonth] = React12.useState(() => selectedMonth || adapter.getMonth(referenceDate));
...
true ? MonthCalendar.propTypes = {
  ...
  currentMonth: import_prop_types4.default.object,
  /**
...
var YearCalendar = React14.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React14.useMemo(() => adapter.getYear(now), [adapter, now]);
  ...
  const [focusedYear, setFocusedYear] = React14.useState(() => selectedYear || adapter.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
